...
def test_upsert_date_validation_errors(api_client: TestClient) -> None:
    ...
    post_json(
        api_client,
        "/api/etf",
        {"code": "510300", "name": "沪深300ETF", "start_date": "202401", "end_date": None},
        expected_status=400,
    )
    ...
    post_json(
        api_client,
        "/api/etf",
        {"code": "510300", "name": "沪深300ETF", "start_date": None, "end_date": "2024"},
        expected_status=400,
    )
    ...
    post_json(
        api_client,
        "/api/etf",
        {"code": "510300", "name": "沪深300ETF", "start_date": "20240201", "end_date": "20240101"},
        expected_status=400,
    )
