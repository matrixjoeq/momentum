...
class RotationAnalysisInputs:
    ...
    stop_scheme: str = "none"  # none|atr|equity_budget
    ...
    atr_stop_execution_time: str | None = None
    ...
    *,
    ...
    return rotation_strategy.backtest_rotation(
        ...
        RotationInputs(
            ...
            stop_scheme=inp.stop_scheme,
            stop_scheme_explicit=bool(inp.stop_scheme_explicit),
            equity_stop_risk_pct=inp.equity_stop_risk_pct,
            ...
            atr_stop_execution_time=inp.atr_stop_execution_time,
