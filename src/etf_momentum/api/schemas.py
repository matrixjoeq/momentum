...
class TrendBacktestRequest(BaseModel):
    ...
    impulse_exit_filter: bool = Field(default=False, description="Universal Impulse exit filter switch (Elder Impulse System)")
    impulse_exit_on_bull: bool = Field(default=False, description="Force exit when impulse state is BULL")
    impulse_exit_on_bear: bool = Field(default=True, description="Force exit when impulse state is BEAR")
    impulse_exit_on_neutral: bool = Field(default=False, description="Force exit when impulse state is NEUTRAL")
