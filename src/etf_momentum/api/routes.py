...
def trend_backtest(payload: TrendBacktestRequest, db: Session = Depends(get_session)) -> dict:
    ...
    inp = TrendInputs(
        ...
        impulse_exit_filter=bool(getattr(payload, "impulse_exit_filter", False)),
        impulse_exit_on_bull=bool(getattr(payload, "impulse_exit_on_bull", False)),
        impulse_exit_on_bear=bool(getattr(payload, "impulse_exit_on_bear", True)),
        impulse_exit_on_neutral=bool(getattr(payload, "impulse_exit_on_neutral", False)),
